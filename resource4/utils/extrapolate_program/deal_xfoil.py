...
def _oper_visc(pcmd, airfoil, operating_point, Re, Mach=None,
             normalize=True, show_seconds=None, iterlim=None, gen_naca=True):
    """
    ...
    while 1:
        ...
        line = xf.readline()
        if line:
            output.append(str(line.decode('utf-8')))
...
class Xfoil():
    ...
    def __init__(self, path=""):
        ...
        self.xfinst = subp.Popen(os.path.join(path, 'xfoil.exe'),
...
if __name__ == "__main__":
    # print((oper_visc_alpha("NACA6604", [-5,15,1], 3000, Mach=.1,
    #                       gen_naca=True, show_seconds=0)))
    print((oper_visc_alpha("../example_extrapolate/ara_d_20.dat", [-5,15,1], 3000, Mach=.1,
                          gen_naca=False, show_seconds=0)))